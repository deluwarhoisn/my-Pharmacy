...
import { ROLE_DESCRIPTIONS, ROLE_LABELS, ROLE_OPTIONS, ROLES, canAccessRole } from './roleAccess'
...
function RoleSwitcher() {
  ...
  return (
    <div className="role-switcher" aria-label="Select platform role">
...
function AccessGate({ allowedRoles, children }) {
  const { role } = useRole()
...
function RoleBanner() {
  ...
  return (
    <div className="role-banner" role="status" aria-live="polite">
      ...
      <div className="page-shell">
          ...
          <nav className="navbar" aria-label="Primary navigation">
            ...
            <div className={`nav-wrap ${isMenuOpen ? 'open' : ''}`}>
              ...
              <ul className="nav-list">
                ...
                <li><NavLink to="/doctor-request" onClick={closeMenu}>ডাক্তার ডাকুন</NavLink></li>
        ...
        <Routes>
          ...
          <Route
            path="/dashboard"
            element={
              <AccessGate allowedRoles={[ROLES.DOCTOR, ROLES.ADMIN]}>
                <DashboardPage />
              </AccessGate>
            }
          />
